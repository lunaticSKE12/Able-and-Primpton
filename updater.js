...
exports.check = () => {
  ...
  autoUpdater.on('update-available', () => {
    ...
    dialog.showMessageBox({
      ...
      message: "A new version of Able and Primpton is available. Do you want to update now?",
      buttons: ['Update', 'No']
    }, (buttonIndex) => {

      // If not 'Update' button, close program
      if (buttonIndex !== 0) {
        app.quit();
      }
      ...
      // Track download progress on autoUpdate
